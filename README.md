...
### I. Proses Training - Perhitungan Invers Matriks (Nama Method : )
...
### J. Proses Training - Perhitungan H+ (Nama Method : )
...
### K. Proses Training - Perhitungan Beta (Nama Method : )
...
### L. Proses Testing - Perhitungan Hinit (Nama Method : )
...
### M. Proses Testing - Perhitungan Heksponential (Nama Method : )
...
### N. Proses Testing - Perhitungan Y testing (Nama Method : )
...
### O. Proses Testing - Perhitungan Evaluasi Error MSE (Nama Method : )
