# EXTREME LEARNING MACHINE pada C#
...
### A. Method Normalisasi Data (Nama Method : normalisasi)
Fungsi normalisasi menerima parameter masukan berupa dataset, data minimal, dan data maksimal
### B. Inisialisasi Bobot (Nama Method : generate_bobot)
...
### C. Inisialisasi Bias (Nama Method : generate_bias)
...
### D. Transpose Matriks (Nama Method : matriks_transpose)
...
### E. Perkalian Matriks (Nama Method : matriks_perkalian)
...
### F. Penjumlahan Matriks dengan Bias (Nama Method : hitung_H)
...
### G. Proses Training - Perhitungan Hinit (Method yang dipakai : matriks_tranpose, matriks_perkalian, ditambah_bias)
...
### H. Proses Training - Perhitungan Heksponential (Method yang dipakai : Hitung_H)
...
### I. Proses Training - Perhitungan Invers Matriks (Nama Method : inverse_matriks)
...
### J. Proses Training - Perhitungan H+ (Nama Method : matriks_perkalian, inverse_matriks)
...
### K. Proses Training - Perhitungan Beta (Nama Method : matriks_perkalian)
...
### L. Proses Testing - Perhitungan Hinit (Nama Method : matriks_transpose, matriks_perkalian, ditambah_bias)
...
### M. Proses Testing - Perhitungan Heksponential (Nama Method : hitung_H)
...
### N. Proses Testing - Perhitungan Y testing (Nama Method : matriks_perkalian)
...
### O. Proses Testing - Perhitungan Evaluasi Error MSE (Nama Method : hitung_MSE)
